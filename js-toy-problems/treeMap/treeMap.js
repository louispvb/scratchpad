...
Tree.prototype.map = function (callback) {
  let ntree = new Tree(callback(this.value));
  ntree.children = this.children.map(oldTree => oldTree.map(callback));
  return ntree;
};
...
Tree.prototype.mapInPlace = function (callback) {
  ...
  this.children.forEach(tree => tree.mapInPlace(callback));
  return this;
};
